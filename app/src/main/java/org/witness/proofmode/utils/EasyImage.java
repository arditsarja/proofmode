...
import static org.witness.proofmode.utils.EasyImageFiles.singleFileList;
...
public class EasyImage implements Constants {
    ...
    private static final String KEY_PHOTO_URI = "org.witness.proofmode.photo_uri";
    private static final String KEY_VIDEO_URI = "org.witness.proofmode.video_uri";
    private static final String KEY_LAST_CAMERA_PHOTO = "org.witness.proofmode.last_photo";
    private static final String KEY_LAST_CAMERA_VIDEO = "org.witness.proofmode.last_video";
    private static final String KEY_TYPE = "org.witness.proofmode.type";
...
//            intent.putExtra("output", FileProvider.getUriForFile(context, context.getPackageName() + ".provider", photoFile));
